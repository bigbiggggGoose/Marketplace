...
public class AuthService {
    ...
    @CacheEvict(cacheNames = "auth:user", allEntries = true)
    ...
    // 修改：返回 UserDto，不返回 ResponseEntity
    @Cacheable(cacheNames = "auth:user", key = "#userId")
    public UserDto getUserByIdData(Long userId) {
    ...
    public UserDto getUserById(Long userId) {
        return getUserByIdData(userId);
    }

    @CacheEvict(cacheNames = "auth:user", key = "#userId")
